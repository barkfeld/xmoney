...
class TEstornaContaPagar extends TJanela
{

function __construct ($Parent, $CodId)
{
    parent::__construct ('Estornar Conta a Pagar', 400, -1, 'contas_pagar.png');
...
function grava_dados ()
{
    ...
    $sql = 'call SP_Mov_Conta_Pagar_Del';
    $data = $sql . '(' .
	    String ($this->CodId) . ',' .
	    String ($anotacoes) . ',' .
	    $GLOBALS ['CodUsuario'] .
