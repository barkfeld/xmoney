...
class TEditaUnidEstoque extends TJanela
{
...
{
    parent::__construct ($operacao == 'i' ? 'Unidade de Estoque - Incluir' : 'Unidade de Estoque - Alterar',
                         null, null, 'unid_estoques.png');
...
function grava_dados ()
{
    ...
    if ($this->operacao == 'i') $sql = 'call SP_Unid_Estoque_Inc';
    else $sql = 'call SP_Unid_Estoque_Alt';
