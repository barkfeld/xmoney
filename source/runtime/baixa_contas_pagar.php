...
class TBaixaContasPagar extends TJanela
{

function __construct ($Parent, $InfoLinha)
{
    parent::__construct ('Contas a Pagar - Baixar', 800, 480, 'contas_pagar.png');
    ...
    // Contas
    $this->pack_start ($frame = new GtkFrame (' Contas a Pagar '));
...
function grava_dados ()
{
    ...
    $sql = 'call SP_Mov_Conta_Pagar_Inc';
    $children = $this->lista->get_children ();
    $max = count ($children) / 8;
    ...
    new Message ($this, 'Conta(s) a Pagar baixada(s) com sucesso!');
