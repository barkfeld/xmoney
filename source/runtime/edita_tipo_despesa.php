...
class TEditaTipoDespesa extends TJanela
{
...
{
    parent::__construct ($operacao == 'i' ? 'Tipo de Despesa - Incluir' : 'Tipo de Despesa - Alterar',
                         null, null, 'tipos_despesa.png');
    ...
    $hbox->pack_start ($this->nome = new AEntry (true, true, 'Tb_Tipos_Despesa', 'Nome'));
...
function grava_dados ()
{
    ...
    if ($this->operacao == 'i') $sql = 'call SP_Tipo_Despesa_Inc';
    else $sql = 'call SP_Tipo_Despesa_Alt';
