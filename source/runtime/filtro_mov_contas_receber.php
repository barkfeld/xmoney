...
class TFiltroMovContasReceber extends TFiltro
{
...
function criar_filtro ()
{
    ...
    $id->set_filter ('CodConta', 'Tb_Mov_Contas_Receber.Cod_S_Conta', 'Cod. Conta:');
    ...
    $dia_pgto->set_filter ('Pagamento', 'Tb_Mov_Contas_Receber.DataInc', ' Data Pgto: ');
