...
class TCancelaContaReceber extends TJanela
{

function __construct ($Parent, $CodId)
{
    parent::__construct ('Cancelar Conta a Receber', 400, -1, 'contas_receber.png');
