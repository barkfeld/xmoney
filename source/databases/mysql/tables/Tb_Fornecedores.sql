...
#
# Structure for the Tb_Fornecedores table : 
#

DROP TABLE IF EXISTS Tb_Fornecedores;

CREATE TABLE Tb_Fornecedores (
  Cod_S_For INTEGER(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  LimiteCompra FLOAT(9,3) UNSIGNED NOT NULL,
  ...
  PRIMARY KEY (Cod_S_For),
  UNIQUE KEY Cod_S_Cli (Cod_S_For),
  KEY Cod_S_Tipo (Cod_S_Tipo),
  KEY Cod_S_Usuario_Inc (Cod_S_Usuario_Inc),
  CONSTRAINT Tb_Fornecedor_Tipo FOREIGN KEY (Cod_S_Tipo) REFERENCES Tb_Tipos_Pessoa (Cod_S_Tipo),
  CONSTRAINT Tb_Fornecedor_Usuario_Inc FOREIGN KEY (Cod_S_Usuario_Inc) REFERENCES Tb_Usuarios (Cod_S_Usuario) ON UPDATE NO ACTION
)ENGINE=InnoDB
