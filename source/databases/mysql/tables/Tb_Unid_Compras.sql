...
#
# Structure for the Tb_Unid_Compras table :
#

DROP TABLE IF EXISTS Tb_Unid_Compras;

CREATE TABLE Tb_Unid_Compras (
  ...
  CONSTRAINT Tb_Unid_Compra_Usuario_Inc FOREIGN KEY (Cod_S_Usuario_Inc) REFERENCES Tb_Usuarios (Cod_S_Usuario) ON UPDATE NO ACTION
)ENGINE=InnoDB
AUTO_INCREMENT=10 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci';

#
# Data for the Tb_Unid_Compras table
#

INSERT INTO Tb_Unid_Compras (Cod_S_Unidade, Nome, Descricao, Cod_S_Usuario_Inc) VALUES 
  (1,'PÇ','Peça',1),
  (2,'MT','Metro',1),
  (3,'KL','Kilo',1),
  (4,'DZ','Dúzia',1),
