...
#
# Structure for the Tb_Contas_Pagar table : 
#
...
CREATE TABLE Tb_Contas_Pagar (
  ...
  KEY Tb_Contas_Pagar_Filial (Cod_S_Filial),
  KEY Tb_Contas_Pagar_TipoDoc (Cod_S_TipoDoc),
  CONSTRAINT Tb_Contas_Pagar_SitConta FOREIGN KEY (Cod_S_Sit) REFERENCES Tb_Sit_Conta (Cod_S_Sit),
  CONSTRAINT Tb_Contas_Pagar_Filial FOREIGN KEY (Cod_S_Filial) REFERENCES Tb_Filiais (Cod_S_Filial) ON UPDATE NO ACTION,
  CONSTRAINT Tb_Contas_Pagar_Fornecedor FOREIGN KEY (Cod_S_For) REFERENCES Tb_Fornecedores (Cod_S_For) ON UPDATE NO ACTION,
  CONSTRAINT Tb_Contas_Pagar_TipoDoc FOREIGN KEY (Cod_S_TipoDoc) REFERENCES Tb_Tipos_Doc (Cod_S_Tipo)
)ENGINE=InnoDB
