...
#
# Structure for the Tb_Mov_Contas_Receber table : 
#

DROP TABLE IF EXISTS Tb_Mov_Contas_Receber;

CREATE TABLE Tb_Mov_Contas_Receber (
  ...
  CONSTRAINT Tb_Mov_Contas_Receber_Banco FOREIGN KEY (Cod_S_Banco) REFERENCES Tb_Bancos (Cod_S_Banco) ON UPDATE NO ACTION,
  CONSTRAINT Tb_Mov_Contas_Receber_Conta FOREIGN KEY (Cod_S_Conta) REFERENCES Tb_Contas_Receber (Cod_S_Conta) ON UPDATE NO ACTION,
  CONSTRAINT Tb_Mov_Contas_Receber_Despesa FOREIGN KEY (Cod_S_Despesa) REFERENCES Tb_Tipos_Despesa (Cod_S_Tipo),
  CONSTRAINT Tb_Mov_Contas_Receber_Forma_Pgto FOREIGN KEY (Cod_S_Forma) REFERENCES Tb_Formas_Pgto (Cod_S_Forma),
  CONSTRAINT Tb_Mov_Contas_Receber_Usuario_Inc FOREIGN KEY (Cod_S_Usuario_Inc) REFERENCES Tb_Usuarios (Cod_S_Usuario) ON UPDATE NO ACTION
)ENGINE=InnoDB
