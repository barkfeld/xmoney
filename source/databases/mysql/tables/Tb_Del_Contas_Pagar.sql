...
#
# Structure for the Tb_Del_Contas_Pagar table : 
#

DROP TABLE IF EXISTS Tb_Del_Contas_Pagar;

CREATE TABLE Tb_Del_Contas_Pagar (
  ...
  CONSTRAINT Tb_Del_Contas_Pagar_Usuario_Inc FOREIGN KEY (Cod_S_Usuario_Inc) REFERENCES Tb_Usuarios (Cod_S_Usuario) ON UPDATE NO ACTION,
  CONSTRAINT Tb_Del_Contas_Pagar_Conta FOREIGN KEY (Cod_S_Conta) REFERENCES Tb_Contas_Pagar (Cod_S_Conta) ON UPDATE NO ACTION
)ENGINE=InnoDB
