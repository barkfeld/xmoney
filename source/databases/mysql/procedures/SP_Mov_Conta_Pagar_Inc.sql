#
# Definition for the SP_Mov_Conta_Pagar_Inc procedure : 
#

DELIMITER $$

DROP PROCEDURE IF EXISTS SP_Mov_Conta_Pagar_Inc$$

CREATE PROCEDURE SP_Mov_Conta_Pagar_Inc(
	...
	COMMENT 'Baixa conta a pagar no sistema'
BEGIN

INSERT INTO Tb_Mov_Contas_Pagar
...
UPDATE Tb_Contas_Pagar SET Cod_S_Sit = 2 WHERE Cod_S_Conta = iCodConta;
SELECT 'Conta a pagar baixada com sucesso!' as Mensagem;
